...
// =============================================================================
// This file is copied from TensorFlow source. With the following changes:
...
#include "tfx_bsl/cc/sketches/weighted_quantiles_buffer.h"
...
class WeightedQuantilesStream {
 public:
  ...
  WeightType ApproximationError(int64_t level = -1) const {
    ...
    assert(level < summary_levels_.size());
